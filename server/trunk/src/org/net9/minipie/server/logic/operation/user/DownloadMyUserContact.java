 ...
 * 
 */
public class DownloadMyUserContact extends Command<String> {
	...
	public DownloadMyUserContact(long userId, String filePath) {
		this.userId = userId;
	...
	public String execute() {
		...
		for (CommonListEntry ce : cl) {
			...
			try {
				...
				os
						.write("Name,RegisteredEmail,NickName,DisplayName,Notes,Birthday,BirthdayPermission"
