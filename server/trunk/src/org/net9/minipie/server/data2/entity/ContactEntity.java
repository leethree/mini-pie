...
public class ContactEntity {
	...
	public ContactEntity() {
		super();
		gender=null;
		genderPermission=null;
		birthdayPermission=null;
		birthyearPermission=null;
		birthday=null;
		permission=null;
		addrs = null;
		emails = null;
	...
	/**
	 * @param registeEmail the registeEmail to set
	 */
	...
	/**
	 * @param genderPermission the genderPermission to set
	 */
	...
	/**
	 * @param birthdayPermission the birthdayPermission to set
	 */
	...
	/**
	 * @param birthyearPermission the birthyearPermission to set
	 */
